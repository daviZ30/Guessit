        ...
        private fun populateDatabase() {
            getInstance().let { database ->
                with(database) {
                    ...
                    AnswerTestDao().insert(AnswerTest("test7","The Dark Knight (El Caballero de la Noche)",false))
                    ...
                    GuessDao().insert(Guess("test12","¿Quién es el máximo goleador de la historia de la Copa Mundial de la FIFA?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test13","¿Quién fue el máximo goleador de la Juventus en su ascenso a la Serie A en la 2006/2007?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test14","¿Quién es el máximo goleador histórico de la Selección Argentina?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test17","¿Cuál es el nombre del río más largo del mundo?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test18","¿Cuál es el océano más grande del mundo?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test19","¿Cuál es el país más grande del mundo?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test20","¿Cuál es el país que tiene forma de bota?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
                    ...
                    GuessDao().insert(Guess("test21","¿Cuál es el país más poblado de la tierra?", Difficulty.Medium, Category.NULL ,GuessType.TEST))
